...
class Review(TimeStampedMixin):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="reviews", verbose_name="작성자"
    )
    ...
    content = models.CharField(
        max_length=280, null=False, blank=False, verbose_name="리뷰 내용"
    )
    reported_user = models.ManyToManyField(
        User, through="ReviewReport", blank=True, verbose_name="리뷰 신고한 유저"
    )
