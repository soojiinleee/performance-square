...
class TestReviewList:
    ...
    def test_specific_performance_review_list(
        self, api_client, performance_data, review_data
    ):
        """특정 공연의 리뷰 목록 조회 테스트"""
        ...
        response = api_client.get(
            self.url, {"performance_id": performance_data["performance1"].id}
        )
    ...
    def test_ordered_my_review_list(self, api_client, review_data):
        ...
        response = api_client.get(
            self.url, {"is_my_review": True, "ordering": "performance__name"}
        )
...
class TestReviewDetail:
    ...
    def test_update_other_user_review(self, api_client, review_data):
        ...
        assert (
            ...
            == "이 리뷰를 수정할 권한이 없습니다. 작성자만 수정 할 수 있습니다."
        )

    def test_update_review_author(self, api_client, review_data):
        """다른 유저 리뷰 업데이트 테스트"""
    ...
    def test_create_review(self, api_client, performance_data, review_data):
        ...
        response = api_client.post(
            url, {"performance": performance_id, "content": "너무 즐거웠어요"}
        )
    ...
    def test_destroy_review(self, api_client, performance_data, review_data):
        ...
        create_response = api_client.post(
            list_url, {"performance": performance_id, "content": "너무 즐거웠어요"}
        )
...
class TestReviewReport:
    ...
    def test_my_reviews_exclude_reported_reviews(
        self, api_client, review_data, review_report_data
    ):
    ...
    def test_content_of_reported_review(
        self, api_client, performance_data, review_data, review_report_data
    ):
        """신고 누적 5회 리뷰 컨텐츠 테스트"""
        ...
        response = api_client.get(
            performance_review_url, {"performance_id": performance_id}
        )
